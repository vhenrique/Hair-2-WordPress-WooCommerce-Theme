...
<body onLoad="javascript:inicializaAjax();carregarFornecedores();">
<h3 class="titulo_secao">Fornecedores Cadastrados</h3>
<form method="post" action="" name="Cadastro">
Digite alguma palavra-chave do nome do fornecedor a ser pesquisado...<br>
<input type="text" name="Nome" size="79" onFocus="iniciaLista();" onKeyUp="atualizaLista();"><br><br>
<input type="button" onClick="javascript:enviaForm('formFornecedor.php?acao=edita',false);" value="Editar">
<input type="button" onClick="javascript:enviaForm('remover.php?tabela=fornecedores',true);" value="Excluir">
<br><br>
<div id="Opcoes">
</div>
</form>
